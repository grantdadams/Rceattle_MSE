...
plot_ssb(projected_OM_no_F, file = "Results/Figures/GOA_OM_", model_names = om_names_print[1:3], width = 6, height = 4.5, line_col = MPcols[c(1,3,5,1,3,5)], lty = c(1,1,1,6,6,6), species = c(1,3,2))
plot_biomass(projected_OM_no_F, file = "Results/Figures/GOA_OM_", model_names = om_names_print[1:3], width = 6, height = 4.5, line_col = MPcols[c(1,3,5,1,3,5)], lty = c(1,1,1,6,6,6), species = c(1,3,2))
...
plot_ssb(projected_OM_no_F, file = "Results/Figures/GOA_OM_projection", model_names = om_names_print[1:3], incl_proj = TRUE, width = 7, height = 6, line_col = MPcols[c(3:1, 3:1)], lty = c(1,1,1,6,6,6), maxyr = 2060)
...
# SAFS 313-12
# - No SRR
summary_fun(system = "GOA1977", spname_system = "GOA",
            om_list_no_F = projected_OM_no_F, om_names = om_names, 
            om_hcr_list_fixM = om_hcr_list_fixM, 
            om_hcr_list_estM = om_hcr_list_estM, 
            em_hcr_names = em_hcr_names[1])
