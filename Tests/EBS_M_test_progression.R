...
MSE_names <- c("Tests/M tests/EBS/Test1 - SS Est M OM, Est M EM Base/", 
               "Tests/M tests/EBS/Test2 - SS Est M OM, Est M EM Sampling timing/", 
               "Tests/M tests/EBS/Test3 - SS Est M OM, Est M EM Rec dev/", 
               "Tests/M tests/EBS/Test4 - SS Est M OM, Est M EM Rec dev and sampling timing/", 
               "Tests/M tests/EBS/Test5 - SS Est M OM, Est M EM Sampling error/", 
               "Tests/M tests/EBS/Test6 - SS Est M OM, Est M EM Rec dev and sampling timing and sampling error/", 
              
               "Tests/M tests/EBS/Regen/Test1 - SS Est M OM, Est M EM Base/", 
               "Tests/M tests/EBS/Regen/Test2 - SS Est M OM, Est M EM Sampling timing/", 
               "Tests/M tests/EBS/Regen/Test3 - SS Est M OM, Est M EM Rec dev/", 
               "Tests/M tests/EBS/Regen/Test4 - SS Est M OM, Est M EM Rec dev and sampling timing/", 
               "Tests/M tests/EBS/Regen/Test5 - SS Est M OM, Est M EM Sampling error/",
               "Tests/M tests/EBS/Regen/Test6 - SS Est M OM, Est M EM Rec dev and sampling timing and sampling error/" 
)
