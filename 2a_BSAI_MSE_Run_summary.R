...
# - No SRR OMs
summary_fun(system = "EBS", om_list_no_F = projected_OM_no_F[1:3], om_names = om_names[1:3],
            om_hcr_list_fixM = om_hcr_list_fixM, 
            om_hcr_list_estM = om_hcr_list_estM, 
            em_hcr_names = em_hcr_names, species = 1:3) 

# - Ricker SRR OMs
summary_fun(system = "EBS", om_list_no_F = projected_OM_no_F[4:6], om_names = om_names[4:6],
