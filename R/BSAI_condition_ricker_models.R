...
ss_run_ricker_AvgF <- fit_mod(data_list = BS2017SS,
...
# -- Constant Fspr
ss_run_ricker_Fspr <- Rceattle::fit_mod(data_list = BS2017SS,
                                 inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                 phase = "default", 
                                 estimateMode = 0, # Run projection only
...
# -- NPFMC Tier 3
ss_run_ricker_Tier3 <- Rceattle::fit_mod(data_list = BS2017SS,
...
ss_run_ricker_dynamicTier3 <- Rceattle::fit_mod(data_list = BS2017SS,
                                         inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                         phase = "default", 
                                         estimateMode = 0, # Run projection only
                                         HCR = build_hcr(HCR = 5, # Tier3 HCR
...
# -- PFMC Category 1
ss_run_ricker_Cat1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                 inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                 phase = "default", 
                                 estimateMode = 0, # Run projection only
...
ss_run_ricker_dynamicCat1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                        inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                        phase = "default", 
                                        estimateMode = 0, # Run projection only
                                        HCR = build_hcr(HCR = 6, # Cat 1 HCR
...
# -- SESSF Tier 1
ss_run_ricker_Tier1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                  inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                  phase = "default", 
                                  estimateMode = 0, # Run projection only
...
ss_run_ricker_dynamicTier1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                         inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                         phase = "default", 
                                         estimateMode = 0, # Run projection only
                                         HCR = build_hcr(HCR = 7, # Tier 1 HCR
...
ss_run_ricker_M_AvgF <- Rceattle::fit_mod(data_list = BS2017SS,
...
# -- Constant Fspr
ss_run_ricker_M_Fspr <- Rceattle::fit_mod(data_list = BS2017SS,
                                   inits = ss_run_ricker_M$estimated_params, 
                                   phase = "default", # Initial parameters from ss_run_ricker_M
                                   estimateMode = 0, # Run projection only
                                   M1Fun = build_M1(M1_model = 1,
...
# -- NPFMC Tier 3
ss_run_ricker_M_Tier3 <- Rceattle::fit_mod(data_list = BS2017SS,
                                    inits = ss_run_ricker_M$estimated_params, 
                                    phase = "default", # Initial parameters from ss_run_ricker_M
                                    estimateMode = 0, # Run projection only
                                    M1Fun = build_M1(M1_model = 1,
...
ss_run_ricker_M_dynamicTier3 <- Rceattle::fit_mod(data_list = BS2017SS,
                                           inits = ss_run_ricker_M$estimated_params, 
                                           phase = "default", # Initial parameters from ss_run_ricker_M
                                           estimateMode = 0, # Run projection only
                                           M1Fun = build_M1(M1_model = 1,
...
# -- PFMC Category 1
ss_run_ricker_M_Cat1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                   inits = ss_run_ricker_M$estimated_params, 
                                   phase = "default", # Initial parameters from ss_run_ricker_M
                                   estimateMode = 0, # Run projection only
                                   M1Fun = build_M1(M1_model = 1,
...
ss_run_ricker_M_dynamicCat1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                          inits = ss_run_ricker_M$estimated_params, 
                                          phase = "default", # Initial parameters from ss_run_ricker_M
                                          estimateMode = 0, # Run projection only
                                          M1Fun = build_M1(M1_model = 1,
...
# -- SESSF Tier 1
ss_run_ricker_M_Tier1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                    inits = ss_run_ricker_M$estimated_params, 
                                    phase = "default", # Initial parameters from ss_run_ricker_M
                                    estimateMode = 0, # Run projection only
                                    M1Fun = build_M1(M1_model = 1,
...
ss_run_ricker_M_dynamicTier1 <- Rceattle::fit_mod(data_list = BS2017SS,
                                           inits = ss_run_ricker_M$estimated_params, 
                                           phase = "default", # Initial parameters from ss_run_ricker_M
                                           estimateMode = 0, # Run projection only
                                           M1Fun = build_M1(M1_model = 1,
