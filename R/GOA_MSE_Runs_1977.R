...
mod_use <- c(1,2,7,8,9,10,15,16)

# No rec trend
run_mse(system = "GOA1977", recname = "ConstantR", om_list = om_list[1:2], om_names = om_names[1:2], em_hcr_list = em_hcr_list[-mod_use], em_hcr_names = em_hcr_names[-mod_use], sampling_period = sampling_period, nsim = 300)
