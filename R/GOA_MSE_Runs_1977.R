...
# No rec trend
run_mse(system = "GOA1977", recname = "ConstantR", om_list = om_list[6], om_names = om_names[6], em_hcr_list = em_hcr_list[mod_use], em_hcr_names = em_hcr_names[mod_use], sampling_period = sampling_period, nsim = 300)
