...
EM_names_print <-  c("Fix M: HCR 1a (NPFMC)", "Fix M: HCR 1b (NPFMC)", 
                     "Est M: HCR 1a (NPFMC)", "Est M: HCR 1b (NPFMC)",
                     "Fix M: HCR 2a (PFMC)", "Fix M: HCR 2b (PFMC)", 
                     "Est M: HCR 2a (PFMC)", "Est M: HCR 2b (PFMC)", 
                     "Fix M: HCR 3a (SESSF)", "Fix M: HCR 3b (SESSF)", 
                     "Est M: HCR 3a (SESSF)", "Est M: HCR 3b (SESSF)", 
                     "Fix M: HCR 4 (NEFMC)", "Est M: HCR 4 (NEFMC)",
                     "Fix M: HCR 5 (Avg F)", "Est M: HCR 5 (Avg F)")
