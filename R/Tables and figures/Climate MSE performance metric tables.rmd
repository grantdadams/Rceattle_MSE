...
performance_metrics <- c("Average Catch", "Catch IAV", # "Avg terminal SSB Relative MSE" ,
                         "OM: P(SSB < SSBlimit)" , "OM: Terminal SSB", "OM: Terminal Dynamic SB0", "OM: Terminal SSB Depletion (Dynamic)") # Names in table
...
for(sp in 1:3){
  for(pm in 1:length(performance_metrics)){
    ...
    # - Write table
    print(paste0("**Supplementary Table ", 0+sp, ".PM-",pm,".** Summary of performance metric ", pm," (", performance_metrics_print[pm], ") across OMs for **", species,"**."))
