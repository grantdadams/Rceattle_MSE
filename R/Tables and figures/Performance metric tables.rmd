...
for(sp in 1:3){
  ...
  # - Print via rmarkdown
  print(paste0("**Supplementary Table ", 7, c("a", "b", "c")[sp],".** Number of times a management strategy performed the best for performance metrics across OMs for **", species, "**. Note, the maximum for each OM is 9 and across OMs is 54."))
