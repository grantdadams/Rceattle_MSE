...
for(sp in 1:3){
  ...
  # - Print via rmarkdown
  print(paste0("**Supplementary Table ", 6+sp,".** Number of times a management strategy performed the best for performance metrics across OMs for **", species, "**. Note, the maximum for each OM is 9 and across OMs is 54."))
...
for(sp in 1:3){
  ...
  # - Print via rmarkdown
  print(paste0("**Supplementary Table ", 9+sp,".** Number of times a management strategy performed the best for economic performance metrics (1-3) across OMs for **", species, "**. Note, the maximum for each OM is 3 and across OMs is 18."))
...
for(sp in 1:3){
  ...
  # - Print via rmarkdown
  print(paste0("**Supplementary Table ", 12+sp,".** Number of times a management strategy performed the best for conservation performance metrics (5-9) across OMs for **", species, "**. Note, the maximum for each OM is 4 and across OMs is 24."))
