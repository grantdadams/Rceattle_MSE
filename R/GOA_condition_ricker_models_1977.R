...
mod_list_all <- mod_list_all #  <- list(ss_run_ricker_OM, ss_run_ricker_M_OM, ms_run_ricker_OM)
...
################################################
ms_run_ricker_f25 <- Rceattle::fit_mod(data_list = ms_run_ricker$data_list,
...
ss_run_ricker_AvgF <- fit_mod(data_list = ss_run_ricker$data_list,
...
# -- Constant Fspr
ss_run_ricker_Fspr <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
...
# -- NPFMC Tier 3
ss_run_ricker_Tier3 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                         inits = ss_run_ricker$estimated_params,
                                         estimateMode = 0, # Run projection only
...
ss_run_ricker_dynamicTier3 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                                inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                                estimateMode = 0, # Run projection only
                                                HCR = build_hcr(HCR = 5, # Tier3 HCR
...
# -- PFMC Category 1
ss_run_ricker_Cat1 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                        inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                        estimateMode = 0, # Run projection only
...
ss_run_ricker_dynamicCat1 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                               inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                               estimateMode = 0, # Run projection only
                                               HCR = build_hcr(HCR = 6, # Cat 1 HCR
                                                               DynamicHCR = TRUE, # Use dynamic reference points
...
# -- SESSF Tier 1
ss_run_ricker_Tier1 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                         inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                         estimateMode = 0, # Run projection only
...
ss_run_ricker_dynamicTier1 <- Rceattle::fit_mod(data_list = ss_run_ricker$data_list,
                                                inits = ss_run_ricker$estimated_params, # Initial parameters from ss_run_ricker
                                                estimateMode = 0, # Run projection only
                                                HCR = build_hcr(HCR = 7, # Tier 1 HCR
                                                                DynamicHCR = TRUE,
...
ss_run_ricker_M_AvgF <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                          inits = s_run_ricker_M$estimated_params, 
                                          phase = "default",
                                          estimateMode = 0, # Run projection only
                                          M1Fun = build_M1(M1_model = c(1,2,1),
                                                           M1_use_prior = FALSE,
...
# -- Constant Fspr
ss_run_ricker_M_Fspr <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                          inits = s_run_ricker_M$estimated_params, 
                                          phase = "default",
                                          estimateMode = 0, # Run projection only
                                          M1Fun = build_M1(M1_model = c(1,2,1),
...
# -- NPFMC Tier 3
ss_run_ricker_M_Tier3 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                           inits = s_run_ricker_M$estimated_params, 
                                           phase = "default",
                                           estimateMode = 0, # Run projection only
                                           M1Fun = build_M1(M1_model = c(1,2,1),
...
ss_run_ricker_M_dynamicTier3 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                                  inits = s_run_ricker_M$estimated_params, 
                                                  phase = "default",
                                                  estimateMode = 0, # Run projection only
                                                  M1Fun = build_M1(M1_model = c(1,2,1),
...
# -- PFMC Category 1
ss_run_ricker_M_Cat1 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                          inits = s_run_ricker_M$estimated_params, 
                                          phase = "default",
                                          estimateMode = 0, # Run projection only
                                          M1Fun = build_M1(M1_model = c(1,2,1),
...
ss_run_ricker_M_dynamicCat1 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                                 inits = s_run_ricker_M$estimated_params, 
                                                 phase = "default",
                                                 estimateMode = 0, # Run projection only
                                                 M1Fun = build_M1(M1_model = c(1,2,1),
...
# -- SESSF Tier 1
ss_run_ricker_M_Tier1 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
                                           inits = s_run_ricker_M$estimated_params, 
                                           phase = "default",
                                           estimateMode = 0, # Run projection only
                                           M1Fun = build_M1(M1_model = c(1,2,1),
...
ss_run_ricker_M_dynamicTier1 <- Rceattle::fit_mod(data_list = ss_run_ricker_M$data_list,
...
# Plot
###############################################
M_mod_list <- list(ss_run_ricker_M_AvgF, ss_run_ricker_M_Fspr, ss_run_ricker_M_Tier3, ss_run_ricker_M_dynamicTier3, ss_run_ricker_M_Cat1, ss_run_ricker_M_dynamicCat1, ss_run_ricker_M_Tier1, ss_run_ricker_M_dynamicTier1 )
mod_list <- list(ss_run_ricker_AvgF, ss_run_ricker_Fspr, ss_run_ricker_Tier3, ss_run_ricker_dynamicTier3, ss_run_ricker_Cat1, ss_run_ricker_dynamicCat1, ss_run_ricker_Tier1, ss_run_ricker_dynamicTier1 )
