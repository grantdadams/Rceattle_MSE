...
apply(ss_run_ricker$quantities$biomassSSB, 1, max)
1/(beta/1000000)
#plot_ssb(list(ss_run_ricker, ss_run_ricker), incl_proj = TRUE)
...
# #plot_ssb(list(ms_run_ricker, ms_run, ss_run_ricker_M, ss_run_ricker_M), incl_proj = TRUE, model_names = 1:4)
# #plot_biomass(list(ms_run_ricker, ms_run, ss_run_ricker_M, ss_run_ricker_M), incl_proj = TRUE, model_names = 1:4)
# #plot_recruitment(list(ms_run_ricker, ms_run, ss_run_ricker_M, ss_run_ricker_M), incl_proj = TRUE, model_names = 1:4)
