...
# No cap
run_climate_mse(system = "GOA_Climate_2018", om_list = om_list, om_names = om_names, em_hcr_list = em_list[1:2], em_hcr_names = em_names[1:2], sampling_period = sampling_period, nsim = 300, regenerate_past = FALSE, cap = NULL)

# Cap
run_climate_mse(system = "GOA_Climate_2018", om_list = om_list, om_names = om_names, em_hcr_list = em_list[1:2], em_hcr_names = em_names[1:2], sampling_period = sampling_period, nsim = 300, regenerate_past = FALSE, cap = cap_list)
