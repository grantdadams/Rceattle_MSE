...
histogram_by_om <- function(system = "GOA", recname = "ConstantR", species = "Pollock", file = NULL, height = 7, width = 6, allHCR = FALSE, single = FALSE){
