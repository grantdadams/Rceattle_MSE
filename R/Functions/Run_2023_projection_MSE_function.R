...
#'
#' @examples
run_mse <- function(system = "GOA1977", om_list = NULL, om_names = NULL, em_hcr_list = NULL, em_hcr_names = NULL, sampling_period = NULL, nsim = 200, start_sim = 1, cap = NULL, catch_mult = NULL){
