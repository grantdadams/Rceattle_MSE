...
# No rec trend
run_mse(system = "EBS", recname = "ConstantR", om_list = om_list, om_names = om_names, em_hcr_list = em_hcr_list[mod_use], em_hcr_names = em_hcr_names[mod_use], sampling_period = sampling_period, nsim = 300)
