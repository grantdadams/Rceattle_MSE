...
# No rec trend
run_mse(system = "EBS", recname = "ConstantR", om_list = om_list[4], om_names = om_names[4], em_hcr_list = em_hcr_list, em_hcr_names = em_hcr_names, sampling_period = sampling_period, nsim = 300)
