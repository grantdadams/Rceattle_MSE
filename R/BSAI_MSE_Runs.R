...
mse5 <- mse_run(om = ss_run_M, em = ss_run_Tier3, nsim = 200, assessment_period = 1, sampling_period = c(1,1,1,1,1,1,2), simulate = TRUE, cap = cap_list[[1]], dir = "Runs/EBS/SS_OM/SS_Tier3_EM/ConstantR/Cap1", file = NULL)

# - SS-OM: SSM-EM Tier 3 HCR
mse6 <- mse_run(om = ss_run_M, em = ss_run_M_Tier3, nsim = 200, assessment_period = 1, sampling_period = c(1,1,1,1,1,1,2), simulate = TRUE, cap = cap_list[[1]], dir = "Runs/EBS/SS_OM/SS_M_Tier3_EM/ConstantR/Cap1", file = NULL)
