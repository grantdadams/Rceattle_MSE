...
################################################
load("~/GitHub/Rceattle_MSE/Models/18_5_1_re_3iter_Mod_12_2021-09-11.Rdata")
run_list <- list(mod_re)
load("~/GitHub/Rceattle_MSE/Models/18_5_1_re_3iter_Mod_13_2021-09-11.Rdata")
run_list[[2]] <- mod_re
...
for(i in 1:2){
  ...
  # run_list[[i]]$estimated_params$ln_FSPR <- run_list[[i]]$estimated_params$ln_FSPR[1:3,]
  # 
  # run_list[[i]]$estimated_params$sel_coff_dev <- array(0, dim = c(16,2,19,23))
}
ss_run <-  run_list[[1]]
ms_run <-  run_list[[2]]
