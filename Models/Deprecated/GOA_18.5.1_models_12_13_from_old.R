...
for(i in 1:2){
  ...
  # Dynamic params
  run_list[[i]]$estimated_params$ln_Flimit <- matrix(0, 3, 65)
  run_list[[i]]$estimated_params$ln_Ftarget <- matrix(0, 3, 65)
...
save(ss_run, ss_run_M, ms_run, file = "Models/GOA_Models_from_previous.RData")
